...
const struct chainparams networks[] = {
    {.network_name = "vipstarcoin",
     .bip173_name = "vips",
     .bip70_name = "main",
     .genesis_blockhash = {{{.u.u8 = {0x7c, 0xb7, 0x09, 0xee, 0xb1, 0x06, 0x15,
				      0x13, 0x5c, 0x29, 0x22, 0xa7, 0xa6, 0x69,
				      0xee, 0xc6, 0xe9, 0x6b, 0x10, 0x37, 0x61,
				      0x44, 0x64, 0xfb, 0x79, 0x0f, 0xd3, 0xe1,
				      0x68, 0xd0, 0x00, 0x00}}}},
     .rpc_port = 31916,
     .cli = "vipstarcoin-cli",
     .cli_args = NULL,
